        ...
        <div class="row doctor justify-content-center">
            <div class="col-4 card text-center">
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-4">
                            <img src="https://img.icons8.com/officel/80/null/triangular-bandage.png" alt="profil picture" class="rounded-circle border border-5 border-light" />
                        </div>
                    ...
                    <div class="text-start">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="patient_secu" id="patient_secu" class="form-control" placeholder="Numéro de sécurité social" aria-label="Input group example" aria-describedby="btnGroupAddon" value='' disabled>
                        </div>
                    </div>
